...
from app.features.suggestions.suggestion_service import SuggestionService
...
class SuggestionController(QObject):
    ...
    def __init__(
        ...
        self._files: FileListModel | None = None
    ...
    def schedule_refresh(self, files: FileListModel, delay_ms: int = 250) -> None:
        self._files = files
        self._timer.start(delay_ms)

    def refresh_now(self, files: FileListModel | None = None) -> None:
